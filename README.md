...
このツールでは、クラウドワークス上の案件情報を収集・構造化し、AIエージェントが読み取り・分析しやすいデータとして整理します。これにより、案件の比較、応募優先度の整理、リスク確認、提案文作成などを、あなたが普段使っているAIエージェントと一緒に進めやすくすることを目的としています。
...
* OpenAI APIによる簡易分析を行い、案件を応募候補ランキング順に並べたMarkdown形式レポートとして出力します。
